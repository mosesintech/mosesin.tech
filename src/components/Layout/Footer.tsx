...
export default function Footer() {
  const footerNavigation = {
    ...
    social: [
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/mosesintech/',
        icon: (props: { [x: string]: string }) => (
      ...
      {
        name: 'Twitter',
        href: 'https://twitter.com/mosesintech/',
        icon: (props: { [x: string]: string }) => (
          <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
  ...
  return (
    <footer className='bg-gray-50' aria-labelledby='footer-heading'>
      ...
      <div className='max-w-[1350px] mx-auto pb-8 px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mt-12 border-t border-gray-900 pt-8 md:flex md:items-center md:justify-between lg:mt-16'>
